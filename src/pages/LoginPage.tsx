...
const LoginPage = () => {
  ...
  try {
    ...
    console.log('📊 Estado do Auth:', { isAuthenticated, loading, userEmail: user?.email });

    // Redirecionar se já estiver autenticado
    useEffect(() => {
      console.log('🔄 Verificando redirecionamento...', { loading, isAuthenticated, userRole: user?.role });
    ...
    console.error('❌ Erro crítico no LoginPage:', error);
    return (
      <div className="min-h-screen bg-gradient-to-br from-blue-50 to-indigo-100 flex items-center justify-center">
        <div className="text-center">
          <p className="text-red-600 mb-2">Erro ao carregar sistema</p>
          <p className="text-sm text-gray-600">Verifique o console para mais detalhes</p>
        </div>
      </div>
    );
  }
