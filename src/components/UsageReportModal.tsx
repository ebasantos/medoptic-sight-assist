    ...
    <Dialog open={isOpen} onOpenChange={setIsOpen}>
      ...
      <DialogContent className="max-w-6xl max-h-[90vh] overflow-hidden">
        ...
        <div className="space-y-6">
          ...
          <Card>
            <CardHeader>
              <CardTitle className="text-lg">Resumo Geral do Sistema</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="grid grid-cols-2 md:grid-cols-6 gap-4">
                <div className="text-center">
                  <div className="text-2xl font-bold text-blue-600">{stats.totalOpticas}</div>
                  <div className="text-sm text-gray-600">Total Óticas</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-green-600">{stats.opticasAtivas}</div>
                  <div className="text-sm text-gray-600">Ativas</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-red-600">{stats.opticasBloqueadas}</div>
                  <div className="text-sm text-gray-600">Bloqueadas</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-purple-600">{stats.totalUsuarios}</div>
                  <div className="text-sm text-gray-600">Usuários</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-orange-600">{stats.totalAfericoes}</div>
                  <div className="text-sm text-gray-600">Aferições</div>
                </div>
                <div className="text-center">
                  <div className="text-2xl font-bold text-indigo-600">{stats.totalSimulacoes}</div>
                  <div className="text-sm text-gray-600">Simulações IA</div>
                </div>
              </div>
            </CardContent>
          </Card>
          ...
          <Card>
            <CardHeader className="flex flex-row items-center justify-between">
              <CardTitle className="text-lg">Detalhamento por Ótica</CardTitle>
            ...
            <CardContent>
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div className="space-y-2">
                  <h4 className="font-medium">Taxa de Adoção do Simulador IA</h4>
                ...
                <div className="space-y-2">
                  <h4 className="font-medium">Média de Simulações por Ótica Ativa</h4>
